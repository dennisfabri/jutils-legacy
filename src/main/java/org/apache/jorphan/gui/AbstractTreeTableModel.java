...
public abstract class AbstractTreeTableModel extends DefaultTableModel implements TreeTableModel {
    ...
    /**
     * By default the abstract class returns true. It is up to subclasses to
    ...
    /**
     * Subclasses need to implement the logic for the method and return the
     * value at the specific cell.
     * <p>
     * {@inheritDoc}
     */
    @Override
     ...
     * returns isLeaf(), otherwise it returns false.
     * 
     * @param node
