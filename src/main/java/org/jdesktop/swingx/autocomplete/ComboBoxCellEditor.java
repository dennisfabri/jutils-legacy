...
public class ComboBoxCellEditor<T> extends DefaultCellEditor {
     ...
     */
    public ComboBoxCellEditor(final JComboBox<T> comboBox) {
        super(comboBox);
        ...
        this.delegate = new EditorDelegate() {
            ...
            private static final long serialVersionUID = -8538572691866289283L;
            ...
            public void actionPerformed(ActionEvent e) {
                JTextComponent editor = ComboBoxUtil.getEditorComponent(comboBox);
                if (editor.getDocument() instanceof AutoCompleteDocument) {
                    AutoCompleteDocument document = (AutoCompleteDocument) editor.getDocument();
