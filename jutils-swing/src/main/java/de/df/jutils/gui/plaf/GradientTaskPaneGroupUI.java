...
public class GradientTaskPaneGroupUI extends BasicTaskPaneGroupUI {
    ...
    class JAuswertungPaneBorder extends PaneBorder {
        ...
        public JAuswertungPaneBorder() {
            ...
            titleBackgroundGradientStart = ColorUtils.calculateColor(UIManager.getColor("Panel.background"),
                    Color.BLACK, 0.1); // UIManager.getColor("InternalFrame.activeTitleBackground");
