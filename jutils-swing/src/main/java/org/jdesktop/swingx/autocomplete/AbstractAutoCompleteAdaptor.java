...
abstract class AbstractAutoCompleteAdaptor {
     ...
     * 
     * @param itemAsString the string representation in use for the currently
     *                     selected item
     */
    ...
    /**
     * Marks/selects the text that is displayed inside the text component starting
     * from the character with index <tt>start</tt>.
     * 
