...
final class Contract {
    ...
    /**
     * Tests the input parameter against null. If the input is an array, checks all
     * of its elements as well. Returns the unchanged parameter if not null, throws
     * a NullPointerException otherwise.
     * <p>
     * PENDING: type of exception? there are raging debates, some favour an
     * IllegalArgument?
     * <p>
     * PENDING: the implementation uses a unchecked type cast to an array. can we do
     * better, how?
     * 
